...
def parse_opt():
    ...
    parser.add_argument('--beta', default=1.0, type=float,
                        help='margin scale.')
    parser.add_argument('--num_branch', default=2, type=int,
                        help='Number of model branch.')
    parser.add_argument('--if_boost_manner', action='store_true',
                        help='Whether to train in the boosting manner.')
